...
channel of scattered output pixels to 0.0. Reported to Apple; unfixed as of
Xcode 26.6. The defect is register-allocation sensitive: MTL_SHADER_VALIDATION=1
masks it entirely, so none of the other RT stages can see it -- they all run
with shader validation on. This stage therefore runs with validation explicitly *off* and
